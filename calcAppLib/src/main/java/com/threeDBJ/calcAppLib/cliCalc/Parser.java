...
// TODO -- Find why hack fix is necessary
final int state_peek(int relative) {
    return (stateptr < 0) ? statestk[0] : statestk[stateptr-relative];
}
//###############################################################
...
ParserVal yyval=new ParserVal(); //used to return semantic vals from action routines
ParserVal yylval=new ParserVal();//the 'lval' (result) I got from yylex()
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
null,null,null,null,null,null,null,null,"NUM","FNCT","NEG","VAR",
};
...
boolean doaction;
  ...
  while (true) //until parsing is done, either correctly, or w/error
    ...
    //if (yydebug)
    //Log.e("calc", "state "+yystate+", reducing "+yym+" by rule "+yyn+" ("+yyrule[yyn]+")");
...
case 5:
//#line 40 "calc.y"
{ ((FnctObj) val_peek(3).obj).operate((ComplexNumber)val_peek(1).obj,
                               (ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
case 6:
//#line 43 "calc.y"
{ vars.put(val_peek(2).sval,(ComplexNumber)val_peek(0).obj); 
              yyval = new ParserVal((ComplexNumber)val_peek(0).obj); }
break;
case 7:
//#line 45 "calc.y"
{ yyval = ((CalcItem)(val_peek(0).obj)).getParserVal (); }
break;
case 8:
//#line 47 "calc.y"
{ ComplexMath.Add ((ComplexNumber)val_peek(2).obj,(ComplexNumber)val_peek(0).obj,
                     (ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
case 9:
//#line 50 "calc.y"
{ ComplexMath.Sub ((ComplexNumber)val_peek(2).obj,(ComplexNumber)val_peek(0).obj,
                     (ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
case 10:
//#line 53 "calc.y"
{ ComplexMath.Mult ((ComplexNumber)val_peek(2).obj,(ComplexNumber)val_peek(0).obj,
                      (ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
case 11:
//#line 56 "calc.y"
{ ComplexMath.Div ((ComplexNumber)val_peek(2).obj,(ComplexNumber)val_peek(0).obj,
                     (ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
case 12:
//#line 59 "calc.y"
{ yyval = new ParserVal(ComplexMath.Pow((ComplexNumber)val_peek(2).obj,  
                                      ComplexMath.Quotient(ComplexNumber.newCartesian(1,0),
                                                           (ComplexNumber)val_peek(0).obj))); }
break;
case 13:
//#line 63 "calc.y"
    { ComplexMath.Pow ((ComplexNumber)val_peek(2).obj,(ComplexNumber)val_peek(0).obj,
                     (ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
case 14:
//#line 65 "calc.y"
...
case 15:
//#line 67 "calc.y"
{ ComplexMath.Neg ((ComplexNumber)val_peek(0).obj,(ComplexNumber)pvals.newObj ()); yyval = pvals.get (); }
break;
