...
public class fnEntry extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.fns = new NoImeEditText[NUM_FNS];
        fns[0] = (NoImeEditText) findViewById (R.id.fn1);
        fns[1] = (NoImeEditText) findViewById (R.id.fn2);
        fns[2] = (NoImeEditText) findViewById (R.id.fn3);
        ...
        n = (Button) findViewById(R.id.shift);
            ...
            public void onClick(View v) {
                if (getIndex() > 0) {
                    ...
                    /*
                      ...
                      ", totLen: "+Integer.toString(getCalc().viewStr.length()));
                    */
